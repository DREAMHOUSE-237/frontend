    ...
    <nav className="bg-white shadow-sm font-sans relative z-50">
      ...
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Langue & Aide (Caché sur petit mobile) */}
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-6 space-y-6 shadow-xl absolute w-full left-0 z-50 animate-in slide-in-from-right duration-300">
          ...
          <div className="space-y-4 font-semibold text-gray-800 text-lg">
            <a href="/" className="block hover:text-[#007b83]">Bien en location / Vendre</a>
            <a href="/conseil" className="block hover:text-[#007b83]">Actus & Conseils</a>
            <a href="/recherche" className="block hover:text-[#007b83]">Recherche</a>
            <a href="/contact" className="block hover:text-[#007b83]">Contact</a>
          </div>
...
const DropdownItem = ({ icon: Icon, label, color = "text-gray-800" }) => (
  <button className={`w-full flex items-center space-x-4 px-5 py-2.5 hover:bg-gray-50 transition-colors ${color}`}>
...
const MobileLink = ({ icon: Icon, label, color = "text-gray-800" }) => (
  <button className={`flex items-center space-x-4 py-1.5 ${color}`}>
